        ...
        <div class="card-content">
            <form action="/kategori/{{ $edit->id }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_kategori" id="" value="{{ old('nama_kategori',$edit->nama_kategori) }}" class="form-control form-control-lg @error('nama_kategori') is-invalid @enderror" placeholder="Masukkan Kategori">
                    @error('nama_kategori')
